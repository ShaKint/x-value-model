# streamlit_app.py — UI + סורק אמיתי על בסיס DataHub/yfinance (ללא FMPClient)
import os, hashlib
...
from investing_scanner import scan_universe  # זה כל הייבוא
...
profiles_path = st.sidebar.text_input("נתיב קובץ פרופילים (אופציונלי)", value="")
...
c1, c2 = st.columns(2)
runway_min = c1.number_input("Runway (חודשים) מינימלי", min_value=0.0, value=18.0, step=1.0)  # כרגע לא בשימוש
